...
```bash
curl -O https://raw.githubusercontent.com/jueti/reinstall/cn/reinstall.sh || wget -O ${_##*/} $_
```
...
```batch
certutil -urlcache -f -split https://raw.githubusercontent.com/jueti/reinstall/cn/reinstall.bat
```
