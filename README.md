...
```bash
curl -O https://raw.githubusercontent.com/jueti/reinstall/main/reinstall.sh || wget -O ${_##*/} $_
```

国内服务器：

```bash
curl -O https://gitea.myclocd.host:16666/jueti/reinstall/raw/branch/main/reinstall.sh || wget -O ${_##*/} $_
```
