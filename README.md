...
```bash
curl -O https://gh.llkk.cc/https://raw.githubusercontent.com/jueti/reinstall/cn/reinstall.sh || wget -O ${_##*/} $_
```
...
```batch
certutil -urlcache -f -split https://gh.llkk.cc/https://raw.githubusercontent.com/jueti/reinstall/cn/reinstall.bat
```
