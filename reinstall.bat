...
set confhome=https://raw.githubusercontent.com/jueti/reinstall/main
set confhome_cn=https://gitea.myclocd.host:16666/jueti/reinstall/raw/branch/main/
...
call :check_cygwin_installed || (
    ...
    if not exist setup-!CygwinArch!.exe (
        call :download https://dufs.myclocd.host:16666/setup-!CygwinArch!.exe %~dp0setup-!CygwinArch!.exe || goto :download_failed
    )
